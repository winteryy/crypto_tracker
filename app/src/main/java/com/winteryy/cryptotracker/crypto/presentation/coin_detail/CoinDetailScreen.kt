...
import com.winteryy.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
...
import com.winteryy.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.winteryy.cryptotracker.ui.theme.CryptoTrackerTheme
import com.winteryy.cryptotracker.ui.theme.greenBackground
    ...
    if(state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val trendingContentColor = if(isPositive) {
                ...
                InfoCard(
                    ...
                    contentColor = trendingContentColor
                )
            }
            AnimatedVisibility(
